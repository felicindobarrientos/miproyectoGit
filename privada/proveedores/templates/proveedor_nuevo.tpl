...
<body>
	<div class="formu_ingreso_datos">
		<form action="proveedor_nuevo1.php" method="post" name="formu">
			...
			<p>
				<input type="text" name="nombre" size="45" placeholder="Nombre proveedor" onkeyup="this.value=this.value.toUpperCase()">(*)
			</p>
			<p>
				<input type="text" name="direccion" size="45" placeholder="Direccion">(*)
			</p>
			<p>
